...
PLACEHOLDERS = {
    "__POSTGRES_USER__": os.environ.get("POSTGRES_USER", "admin"),
    "__POSTGRES_PASSWORD__": os.environ.get("POSTGRES_PASSWORD", "password"),
    "__POSTGRES_DB__": os.environ.get("POSTGRES_DB", "db"),
...
def main(argv: list[str]) -> None:
    ...
    root_name = "dashboard_export_ecdc_haigusseire"

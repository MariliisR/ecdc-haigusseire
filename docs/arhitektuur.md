...
| Mõne riigi nädala andmed võivad jääda puudulikuks. | Võrdlused riikide vahel võivad olla ebatäpsed. | Rakendame quality checkid puuduvate väärtuste tuvastamiseks ja märgime puuduvad andmed näidikulaual.
